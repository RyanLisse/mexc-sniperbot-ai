 ...
 */
export const health = api({ method: "GET", path: "/health", expose: true, auth: false }, async () => {
    ...
    const mexcHealth = "healthy";
    // Check WebSocket health (simplified - assume healthy)
    const wsHealth = "healthy";
    const overallStatus = dbHealth === "down" ? "down" :
