...
async function sendOrderWithRetry(url, options, symbol, quoteOrderQty) {
    let attempt = 0;
 ...
 */
export async function placeMarketBuyOrder(request) {
 ...
 */
export async function validateMEXCCredentials() {
    try {
...
let cachedCredentialValidation = null;
export async function ensureMEXCCredentialsValid() {
